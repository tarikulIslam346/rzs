      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent-3">
        ...
        <ul class="navbar-nav ml-auto nav-flex-icons">
          <li class="nav-item dropdown">
              ...
              <div id="comment_notification" class="dropdown-menu dropdown-menu-right dropdown-cyan" aria-labelledby="navbarDropdownMenuLink-4">
                  <a class="dropdown-item" id="comment_notification"><i class="fa fa-bell" style="margin-right: 1%;"></i>
                </a>
              </div>
          </li>
          <li class="nav-item dropdown">
